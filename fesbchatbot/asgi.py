"""
ASGI config for fesbchatbot project.
...
# os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'fesbchatbot.settings')
...
from fesbchatbot_app.consumers import ChatConsumer, ConversationConsumer, ChatbotConsumer
