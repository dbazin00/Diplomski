...
# nltk.download("punkt")
import numpy as np
import fesbchatbot_app.Croatian_stemmer as cro_stem
...
def train():
    with open("fesbchatbot_app/chatbot_data.json", "r", encoding="utf8") as chatbot_data:
