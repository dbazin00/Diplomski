...
def index(request):
    ...
    return render(request, "fesbchatbot_app/index.html", context)
...
def contact(request):
    ...
    return render(request, "fesbchatbot_app/contact.html", context)
...
def login(request):
    ...
    if request.method == "POST":
        ...
        if isAuthorised:
            ...
            return render(request, "fesbchatbot_app/login.html", context)
    else:
        form = LoginForm()
        context = {"pathinfo" : loggedOutNavbar, "form" : form}
        return render(request, "fesbchatbot_app/login.html", context)
...
def registration(request):
    ...
    if request.method == "POST":
        ...
        if newStudentValid:
            ...
            return render(request, "fesbchatbot_app/registration.html", context)
    else:
        form = StudentForm()
...
def studentList(request):
    ...
    return render(request, "fesbchatbot_app/studentList.html", context)
...
def studentInfo(request, username):
    ...
    return render(request, "fesbchatbot_app/studentInfo.html", context)    
...
def myProfile(request):
    ...
    return render(request, "fesbchatbot_app/myProfile.html", context)
...
def conversations(request):
    ...
    return render(request, "fesbchatbot_app/conversations.html", context)
...
def messages(request, username):
    ...
    return render(request, "fesbchatbot_app/messages.html", context)
...
def newPassword(request):
    ...
    if request.method == "POST":
        ...
        if new_password.is_valid():
            ...
            return render(request, "fesbchatbot_app/newPassword.html", context)
...
def chatbot(request):
    ...
    return render(request, "fesbchatbot_app/chatbot.html", context)
...
def myFiles(request):
    ...
    return render(request, "fesbchatbot_app/myFiles.html", context)
...
def error_400_view(request, exception):
    ...
    return render(request, "fesbchatbot_app/error_pages/404.html", context)
...
def error_500_view(request):
    pathInfo = navbarPathInfo(request)
    context = {"pathinfo" : pathInfo }
    return render(request, "fesbchatbot_app/error_pages/500.html", context)